...
map<int, vector<pair<int, Eigen::Matrix<double, 7, 1>>>> FeatureTracker::trackImage(double _cur_time, const shared_ptr<cv::Mat> &_img, const shared_ptr<cv::Mat> &_img1)
{
    TicToc t_r;
    cur_time = _cur_time;
    cur_img = _img;
